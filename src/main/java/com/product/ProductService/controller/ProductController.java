...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<?> addProduct(@Valid @RequestBody ProductRequest productRequest, BindingResult result) {
    ...
    ResponseEntity<Page<ProductResponse>> searchProductByCategory(
        ...
        Page<ProductResponse> resultProducts = productService.getAllProductByCategory(pageable, category);
