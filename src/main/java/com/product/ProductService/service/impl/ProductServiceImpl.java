...
public class ProductServiceImpl implements ProductService {
    ...
    public Page<ProductResponse> getAllProductByCategory(Pageable pageable, String category) {
       ...
       Page<Product> productPage = productRepository.findByCategoryOrderByCreatedAtDesc(category, pageable);

        if (productPage.isEmpty()) {
            throw new ProductServiceCustomException("No products found for category: " + category, HttpStatus.NOT_FOUND.toString());
        }
